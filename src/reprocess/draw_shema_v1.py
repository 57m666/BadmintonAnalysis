...
players_dict = read_json(
    "E:\SoloShuttlePoseRes/new_res/players/player_kp//He_Bing_Jiao_Chen_Yu_Fei_GWANGJU_YONEX_Korea_Masters_2022_Final.json"
)

# you can set loca_info which not to denoise
ball_dict = read_json(
    "E:\SoloShuttlePoseRes/new_res/ball/loca_info(denoise)/He_Bing_Jiao_Chen_Yu_Fei_GWANGJU_YONEX_Korea_Masters_2022_Final/He_Bing_Jiao_Chen_Yu_Fei_GWANGJU_YONEX_Korea_Masters_2022_Final_107710-108326.json"
)
court_dict = read_json(
    "E:/SoloShuttlePoseRes/new_res/courts/court_kp/He_Bing_Jiao_Chen_Yu_Fei_GWANGJU_YONEX_Korea_Masters_2022_Final.json"
)
